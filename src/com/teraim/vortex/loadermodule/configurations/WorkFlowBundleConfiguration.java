...
public class WorkFlowBundleConfiguration extends XMLConfigurationModule {
	...
	private LoggerI o;
	public WorkFlowBundleConfiguration(PersistenceHelper globalPh,
			String server, String bundle,LoggerI debugConsole) {
		super(globalPh, Type.xml, Source.internet, server+bundle.toLowerCase()+"/", bundle,"Workflow bundle       ");
		this.o=debugConsole;
	}

	@Override
	public String getFrozenVersion() {
		return (globalPh.get(PersistenceHelper.CURRENT_VERSION_OF_WF_BUNDLE));
		
	}

	@Override
	protected void setFrozenVersion(String version) {
		globalPh.put(PersistenceHelper.CURRENT_VERSION_OF_WF_BUNDLE,version);
	}
	...
	protected LoadResult prepare(XmlPullParser parser) throws XmlPullParserException, IOException {
		...
		if (this.versionControl) {
			String version = getFrozenVersion();
