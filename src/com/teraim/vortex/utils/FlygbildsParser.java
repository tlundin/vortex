 ...
 */
public class FlygbildsParser extends AsyncTask<Context,Void,ErrorCode>{
	...
	public FlygbildsParser(GlobalState gs, FileLoadedCb fileLoadedCb) {
	...
	protected ErrorCode doInBackground(Context... params) {
		...
		return parse(Constants.GIS_DATA_DIR);
	}
	...
	private List readBundle(XmlPullParser parser) throws XmlPullParserException, IOException, SameOldException {
